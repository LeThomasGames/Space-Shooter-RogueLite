...
public class PlayerShooting : MonoBehaviour
{
    ...
    void lightGun()
    {
            ...
            GameObject bullet1 = BulletPooler.Instance.GetBullet("small");
            ...
            GameObject bullet2 = BulletPooler.Instance.GetBullet("small");
    ...
    void BigGun()
    {
        if (canBigShoot)
        {
            GameObject bullet2 = BulletPooler.Instance.GetBullet("big");
            bullet2.transform.position = bigFirePoint.position;
            bullet2.transform.rotation = Quaternion.Euler(0, 0, transform.eulerAngles.z - 90);
            canBigShoot = false;
